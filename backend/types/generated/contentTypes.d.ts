...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    testimonial_author_name: Schema.Attribute.String;
    testimonial_author_position: Schema.Attribute.String;
...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aboutBrand: Schema.Attribute.String;
    ...
    key_features: Schema.Attribute.Component<
      'add-component.key-features',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    use_cases: Schema.Attribute.Component<'add-component.use-cases', false>;
  };
}
