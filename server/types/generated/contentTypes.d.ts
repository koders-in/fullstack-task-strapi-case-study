...
export interface ApiCaseStudyUserCaseStudyUser
  extends Struct.CollectionTypeSchema {
  collectionName: 'case_study_users';
  info: {
    displayName: 'Case Study User';
    pluralName: 'case-study-users';
    singularName: 'case-study-user';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::case-study-user.case-study-user'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    assets: Schema.Attribute.Media<
      ...
      true
    >;
    case_study_user: Schema.Attribute.Relation<
      'manyToOne',
      'api::case-study-user.case-study-user'
    >;
    ...
    tags: Schema.Attribute.Relation<'oneToMany', 'api::testimony.testimony'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::case-study-user.case-study-user': ApiCaseStudyUserCaseStudyUser;
